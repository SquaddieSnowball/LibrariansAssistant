...
public sealed class BookModel : IBookModel
{
    ...
    /// </summary>
    public BookModel() => (Authors, Title, Genre) = (default!, default!, default!);

    /// <summary>
    /// Initializes a new instance of the <see cref="BookModel"/> class with the specified authors, title, and genre.
    /// </summary>
