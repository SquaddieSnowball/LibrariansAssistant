...
using LibrariansAssistant.Infrastructure.Repositories.Factories;
using LibrariansAssistant.Infrastructure.Repositories.Factories.Implementations;
using LibrariansAssistant.Infrastructure.Services.Abstractions;
using LibrariansAssistant.Infrastructure.Services.Implementations.RepositoryInitializationStringBuilder;
...
internal sealed partial class SettingsView : Form
{
    ...
    {
        IRepositoryInitializationStringBuilder initializationStringBuilder;
